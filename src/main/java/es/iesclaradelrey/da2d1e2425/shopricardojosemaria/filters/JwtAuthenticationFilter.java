...
import es.iesclaradelrey.da2d1e2425.shopricardojosemaria.utils.ProblemDetailsUtils;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String PROTECTED_PATH = "/api/app/v1/**";
